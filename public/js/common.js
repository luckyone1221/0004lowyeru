...
function eventHandler() {
	...
	function calcTooltipsPos(tooltipParent) {
		...
		var leftPos = tooltipParent.getBoundingClientRect().left + window.scrollX;
		var windowWidth = window.innerWidth;
		var tooltip = tooltipParent.querySelector('.tool-tip');
	...
	function togglePills() {
		var grandParents = document.querySelectorAll('.great-parent-js');

		var _iterator = _createForOfIteratorHelper(grandParents),
				_step;
		...
		try {
			var _loop = function _loop() {
				...
				$(parent).find('.item-header-js').click(function () {
					var self = this;
					var thisDD = self.parentElement.querySelector('.item-dropdown-js');
					if (!thisDD) return;
					var allItems = parent.querySelectorAll('.item-dropdown-js');
	...
	function removeFeedBackPopUp() {
		var clickOnPopUp = event.target.closest('.feedback-pop-up-bl');
